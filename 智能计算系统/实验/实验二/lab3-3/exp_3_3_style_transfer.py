...
class VGG19(object):
    ...
    def load_image(self, image_dir, image_height, image_width):
        ...
        self.input_image = scipy.misc.imresize(
            self.input_image, [image_height, image_width, 3]
        )
...
if __name__ == "__main__":
    ...
    for step in range(TRAIN_STEP):
        ...
        image_diff = ALPHA * content_diff / len(
            CONTENT_LOSS_LAYERS
        ...
        if step % 20 == 0:
            ...
            vgg.save_image(
                transfer_image, content_shape, "../output/output_" + str(step) + ".jpg"
            )
